  ...
  <div class="mt-8">
    <div class="container mx-auto px-8">
      ...
      <form @submit.prevent="onSubmit" class="flex flex-col justify-start space-y-6">
        ...
        <div class="row">
          <button type="submit" class="py-3 text-center w-full bg-purple-500 text-white rounded-lg">
            Sign Up
          </button>
        </div>
      </form>
      ...
      <div class="w-full text-center mt-6">
        ...
        <span class="ml-1">
          <router-link :to="{ name: 'Register', param: {} }" class="text-purple-500 font-bold">Sign Up</router-link>
        </span>
      </div>
    </div>
  </div>
